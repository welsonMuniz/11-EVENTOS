...
func (suite *EventDispatcherTestSuite) TestEventDispatcher_Register() {
	...
	//prova real garantir que o handler que passamos foi o registrado
...
func (suite *EventDispatcherTestSuite) TestEventDispatcher_Has() {
	...
	//verificar se os 2 handlres estão registrados
...
func (suite *EventDispatcherTestSuite) TestEventDispatcher_Dispacth() {
	eh := &MockHandler{}
